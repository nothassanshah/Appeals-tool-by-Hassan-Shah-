...
export const Step6Docs: React.FC<Step6DocsProps> = ({
  uploadedFiles,
  setUploadedFiles,
  onNext,
  onBack,
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">Supporting Documentation</h2>
      <p className="text-gray-600 mb-6">Upload any relevant documents to build a stronger case, such as the denial letter, EOB, and pertinent medical records.</p>
      
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Upload Documents (Optional, but highly recommended)
        </label>
